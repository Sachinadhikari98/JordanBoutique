...
<title>Our Sneaker Story | AJ Boutique</title>
...
<h2 class="text-slate-900 dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">AJ Boutique</h2>
</div>
<nav class="hidden md:flex items-center gap-9">
<a class="hover:text-primary transition-colors text-sm font-medium leading-normal" href="#">Shop</a>
<a class="hover:text-primary transition-colors text-sm font-medium leading-normal" href="#">Releases</a>
<a class="text-primary text-sm font-bold leading-normal" href="#">Our Story</a>
<a class="hover:text-primary transition-colors text-sm font-medium leading-normal" href="#">Authentication</a>
</nav>
</div>
...
<div class="text-slate-400 dark:text-[#ba9c9c] flex border-none bg-slate-100 dark:bg-[#392828] items-center justify-center pl-4">
<span class="material-symbols-outlined text-xl">search</span>
</div>
<input class="form-input flex w-full min-w-0 flex-1 border-none bg-slate-100 dark:bg-[#392828] text-slate-900 dark:text-white focus:ring-0 placeholder:text-slate-400 dark:placeholder:text-[#ba9c9c] px-4 pl-2 text-sm font-normal" placeholder="Search grails..."/>
</div>
</label>
<div class="flex gap-2">
<button class="flex items-center justify-center rounded-lg h-10 w-10 bg-slate-100 dark:bg-[#392828] hover:bg-primary/20 transition-colors">
...
<span class="font-bold text-xl">AJ Boutique</span>
</div>
<p class="max-w-sm text-sm leading-relaxed">
                    Celebrating the legacy of the greatest to ever play the game. Authentic sneakers, curated with passion, delivered to your door.
                </p>
</div>
<div>
<h4 class="text-white font-bold mb-6">Quick Links</h4>
<ul class="space-y-4 text-sm">
<li><a class="hover:text-primary" href="#">Shop Sneakers</a></li>
<li><a class="hover:text-primary" href="#">Release Calendar</a></li>
<li><a class="hover:text-primary" href="#">Sell Your Pairs</a></li>
...
<div class="max-w-[1200px] mx-auto px-4 md:px-20 mt-12 pt-8 border-t border-white/5 text-xs text-center md:text-left">
