    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
        ...
        <div class="reveal-on-scroll">
            ...
            <div class="flex items-center gap-4">
                <a href="<?php echo esc_url( get_theme_mod('footer_social_instagram', 'https://www.instagram.com') ); ?>" target="_blank" class="social-icon size-10 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:text-primary hover:border-primary transition-all shadow-sm">
                ...
                <a href="<?php echo esc_url( get_theme_mod('footer_social_x', 'https://www.x.com') ); ?>" target="_blank" class="social-icon size-10 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:text-primary hover:border-primary transition-all shadow-sm">
                ...
                <a href="<?php echo esc_url( get_theme_mod('footer_social_facebook', 'https://www.facebook.com') ); ?>" target="_blank" class="social-icon size-10 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:text-primary hover:border-primary transition-all shadow-sm">
